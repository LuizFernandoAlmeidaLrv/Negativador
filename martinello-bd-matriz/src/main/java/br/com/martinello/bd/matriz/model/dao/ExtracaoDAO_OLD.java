 ...
 * @author luiz.almeida
 */
public class ExtracaoDAO_OLD {

    public boolean retornoExt;
    private PreparedStatement psExtracao, psAvalista, psAvalistaUpdate, psParcela, psPessoa, psExtrator, psProcesso, psAtualizarRegistroExtrator, psVerificaInclusoes,
    ...
    private ResultSet rsExtracao, rsCliente, rsAvalista, rsParcelas, rsProExtrator, rsVerificaParcela, rsVerificaParcelaBaixa, rsParcelasSemRetorno,
            rsParcelasRetornada, rsBuscarParcelasManual, rsParcelaManual, rsVerificaParcelaOriginal, rsConsultaTipoParcelaExtrator, rsConsultaParcelaInclusao, rsVerificaInclusoes;
    ...
    public String getSqlExtracaoFloBaixa() {
        String sqlExtracaoFloBaixa = ""
                ...
                + "          CASE\n"
                + "         WHEN E301TCR.USU_DATNEG > FILIAL.DATA_INICIO_DBNOVO AND\n"
                + "              FILIAL.ID_FILIAL <> '0001' OR(E301TCR.USU_DATNEG > FILIAL.DATA_INICIO_DBNOVO AND\n"
                + "              FILIAL.ID_FILIAL = '0001' AND\n"
                + "              E301TCR.USU_DATNEG <> '04/07/2020')THEN\n"
                + "          E301TCR.USU_CODCTR\n"
                + "         WHEN E301TCR.USU_DATNEG > FILIAL.DATA_INICIO_DBNOVO AND\n"
                + "              FILIAL.ID_FILIAL = '0001' AND\n"
                + "              E301TCR.USU_DATNEG = '04/07/2020' THEN\n"
                + "          SUBSTR(E301TCR.USU_CODCTR, 3)\n"
                + "         WHEN E301TCR.USU_DATNEG < FILIAL.DATA_INICIO_DBNOVO THEN\n"
                + "          SUBSTR(E301TCR.USU_CODCTR, 3)\n"
                + "         WHEN E301TCR.VCTORI + 30 < FILIAL.DATA_INICIO_DBNOVO AND\n"
                + "              USU_DATNEG IS NULL THEN\n"
                + "          SUBSTR(E301TCR.USU_CODCTR, 3)\n"
                + "         WHEN E301TCR.VCTORI + 30 >= FILIAL.DATA_INICIO_DBNOVO AND\n"
                + "              USU_DATNEG IS NULL THEN\n"
                + "          E301TCR.USU_CODCTR"
                ...
                + "       CLIENTE.USU_SITCLI AS SIT_CLIENTE,\n"
                ...
                + "       AVALISTA.SITCLI AS SIT_AVALISTA,\n"
                + "       AVALISTA_INF.NUMRGE AS RG_AVALISTA,\n"
                + "       AVALISTA_INF.ORGRGE AS EXPEDITOR_AVAL,\n"
    ...
    public String getSqlExtracaoFloInclusao() {
        String sqlExtracaoFloInclusao = ""
                ...
                + "    ON AVALISTA.CODCLI = E301TCR.USU_CODAVA\n"
                + "   AND E301TCR.USU_NEGAVA <> 'N'\n"
                + "   AND AVALISTA.USU_SITCLI NOT IN ('08', '09', '12', '13')\n"
                + "  LEFT OUTER JOIN SAPIENS.E085FIS CLIENTE_INF\n"
                + "    ON CLIENTE_INF.CODCLI = CLIENTE.CODCLI\n"
                + "  LEFT OUTER JOIN SAPIENS.E085FIS AVALISTA_INF\n"
                + "    ON AVALISTA_INF.CODCLI = AVALISTA.CODCLI\n"
    ...
    public String getSqlWhereAutomaticoFloI() {
        String sqlWhereAutomaticoFloI = ""
                ...
                + "       CLIENTE.USU_SITCLI NOT IN ('08', '09', '12', '13') AND\n"
                + "       E301TCR.VLRABE >= '25,00' AND E301TCR.USU_CODCTR IS NOT NULL AND\n"
                + "       FILIAL.DATA_INICIO_DBNOVO > '31/12/1900' \n"
                + "   AND ((E301TCR.VCTORI BETWEEN SYSDATE - 45 AND SYSDATE -30 AND\n"
                + "       (E301TCR.USU_DATNEG = '31/12/1900' OR (E301TCR.USU_DATNEG IS NULL))) OR\n"
                + "       (E301TCR.USU_DATNEG > '31/12/1900' AND\n"
                + "       E301TCR.USU_DATBAI > '31/12/1900' AND\n"
                + "       E301TCR.USU_DATNEG < E301TCR.USU_DATBAI AND\n"
                + "       E301TCR.USU_DATALT BETWEEN SYSDATE - 5 AND SYSDATE AND\n"
                + "       E301TCR.VCTORI BETWEEN SYSDATE - 45 AND SYSDATE -30))) AND FILIAL.ATIVO = 'A'";
    ...
    public String getSqlWhereAutomaticoFloB() {
        String sqlWhereAutomaticoFloB = ""
                ...
                + "                         E301TCR.USU_DATBAI IS NULL)))) AND\n"
                + "       E301MCR.SEQMOV =\n"
                + "       (SELECT MAX(SEQMOV)\n"
                + "           FROM SAPIENS.E301MCR\n"
                + "          WHERE E301MCR.NUMTIT = E301TCR.NUMTIT\n"
                ...
                + "     AND (E301TCR.ULTPGT >= USU_DATNEG OR (USU_DATNEG IS NULL) OR E301MCR.DATPGT >= USU_DATNEG)\n"
                + " ";
    ...
    public String getSqlWhereAutomaticoI() {
        ...
        String sqlWhereAutomaticoI = " WHERE ((EXISTS (SELECT 1\n"
                ...
                + "   AND FILIAIS.ATIVO = 'A'\n";
//Foi diminuido o o intervalo de até 15 dias para até 5 dias.
        return sqlWhereAutomaticoI;
    }

    public String getSqlWhereAutomaticoB() {

        String sqlWhereAutomaticoB = "   WHERE (MR02.SIT = 'P' AND MR02.DATAALT BETWEEN SYSDATE - 5 AND SYSDATE AND\n"
                ...
                + "                    AND MR02.DATAPAG BETWEEN SYSDATE - 120 AND SYSDATE\n"
    ...
    public ExtracaoDAO_OLD() {
        ...
        sqlUpdateParcelas = ("UPDATE PARCELA SET DATAPAG = ?, CAPITPAG = ?, SIT = ?, TAXA = ?, JUROS =?, VALOR_CALC = ?, VALOR_PAG = ?, JUROS_PAG = ?, DATA_NEGATIVADA = ?,"
                + " DATA_BAIXA = ?, DATA_ULT_ATUALIZACAO = ?, DATAALT = ?, TIPOPAG = ?, OBSERVACAO = OBSERVACAO || ?, NUMTIT = ?, USU_IDETCR = ?"
                + " WHERE ID_PARCELA = ?");
        ...
        sqlInsertParcelas = "INSERT INTO PARCELA (ID_PARCELA, ID_FILIAL, CODIGO, NUMERO_DOC, DATALAN, VENC, VALOR, DATAPAG,"
                ...
                + " NUMPAR, TIPOPAG, DATA_EXTRACAO, ID_CLIENTE, ID_AVALISTA, CLIENTE, AVALISTA, PRESCRITO, INCLUIR_AVAL, ORIGEM_PROVEDOR, OBSERVACAO, NUMTIT, USU_IDETCR)"
            ...
            for (ExtracaoModel extracaoModel : lExtracaoModel) {
                if (extracaoModel.getOrigemRegistro().equals("M") && extracaoModel.getBdOrigem().equals("SGL")) {
                    ...
                    if (extracaoModel.getTipoParcela().equalsIgnoreCase("B")) {
                        psExtracao = Conexao.getConnection().prepareStatement(getSqlExtracaoFloBaixa() + getSqlWhereManualExtracaoE301TCR());
                    } else {
                    ...
                    if (extracaoModel.getPontoFilial().equals("")) {
                        psExtracao = Conexao.getConnection().prepareStatement(getSqlExtracaoFloInclusao() + getSqlWhereAutomaticoFloI()
                                + "UNION ALL \n" + getSqlExtracaoFloBaixa() + getSqlWhereAutomaticoFloB());
                        //  psExtracao = Conexao.getConnection().prepareStatement(getSqlExtracaoFloBaixa() + getSqlWhereAutomaticoFloB());
                    } else {
                        filial = extracaoModel.getPontoFilial();
                        psExtracao = Conexao.getConnection().prepareStatement(getSqlExtracaoFloInclusao() + getSqlWhereAutomaticoFloI()
                                + "AND FILIAL.FILIAL_SGL = " + filial + " \n UNION ALL \n" + getSqlExtracaoFloBaixa()
                                + getSqlWhereAutomaticoFloB() + "AND FILIAL.FILIAL_SGL = " + filial + " \n");
                        //  psExtracao = Conexao.getConnection().prepareStatement(getSqlExtracaoFloBaixa() + getSqlWhereAutomaticoFloB()
                        //         + "AND FILIAL.FILIAL_SGL = " + filial + " \n");
                        //   psExtracao.setString(1, filial);
                 ...
                 * for novo.
                 */
                // System.out.println("extração:" + getSqlExtracaoFloInclusao() + getSqlWhereAutomaticoFloI()
                //         + "UNION ALL \n" + getSqlExtracaoFloBaixa() + getSqlWhereAutomaticoFloB());
                ...
                while (rsExtracao.next()) {
                    ...
                    try {
                        ...
                        psVerificaParcela.setString(2, rsExtracao.getString("DOC"));
                        psVerificaParcela.setString(3, rsExtracao.getString("CGCCPF"));
                        System.out.println("Filial =" + rsExtracao.getString("FILIAL_FLO") + "  Doc = " + rsExtracao.getString("DOC") + "  cpf = " + rsExtracao.getString("CGCCPF"));
                            ...
                            if ((extracaoModel.getOrigemRegistro().equals("A") && rsExtracao.getString("TIPO_ACAO").equals("I"))
                                ...
                                if (rsConsultaTipoParcelaExtrator.next()) {
                                    if (extracaoModel.getOrigemRegistro().equals("M")) {
                                        ...
                                        psVerificaInclusoes.setString(2, rsExtracao.getString("DOC"));
 ...
 /*  psConsultaTipoParcelaExtrator = Conexao.getConnection().prepareStatement(getSqlSelectParcelas() + getSqlWhereConsultaParcelaExtrator() + getOrderByParcelaExtrator());
                                ...
                                if (rsVerificaParcela.getString("TIPO").equalsIgnoreCase("B")) {
                                    ...
                                    psConsultaParcelaInclusao.setString(2, rsExtracao.getString("DOC"));
...
//                                            || rsConsultaParcelaInclusao.getString("STATUS").equals("FE")) {
                            ...
                            /* Inserção do Registro Automática */
                            insertRegistroInclusao(extracaoModel);
    ...
    public void insertRegistroInclusao(ExtracaoModel extracaoModel) throws ErroSistemaException {
        ...
        try {
            ...
            if (rsExtracao.getString("TELEFONE").length() > 0) {
                psPessoa.setString(11, rsExtracao.getString("TELEFONE"));
            } else {
            ...
            if ((extracaoModel.getBdOrigem().equalsIgnoreCase("SGL") && rsExtracao.getString("AVALISTA").trim().length() > 0)
                ...
                if (rsExtracao.getString("FONE_AVAL").length() > 0) {
                    psAvalista.setString(11, rsExtracao.getString("FONE_AVAL"));
                } else {
    ...
    public void updateRegistro(ExtracaoModel extracaoModel, String retornoExtracao, int idParcelaBanco, int idExtrator, int idClienteUpdate, int idAvalistaUpdate) throws ErroSistemaException {
        try {
            ...
            if (opcao == JOptionPane.OK_OPTION | extracaoModel.getOrigemRegistro().equals("A")) {
                ...
                if (rsExtracao.getString("TELEFONE").length() > 0) {
                    psClienteUpdate.setString(11, rsExtracao.getString("TELEFONE"));
                } else {
                ...
                if ((extracaoModel.getBdOrigem().equalsIgnoreCase("SGL") && rsExtracao.getString("AVALISTA").trim().length() > 0)
                    ...
                    if (rsExtracao.getString("FONE_AVAL").length() > 0) {
                        psAvalistaUpdate.setString(11, rsExtracao.getString("FONE_AVAL"));
                    } else {
    ...
    public void insertBaixa(ExtracaoModel extracaoModel, int idParcelaBanco, String statusExtrator, String statusSpc, String statusSpcAval, String statusFacmat, Connection connection) throws ErroSistemaException {
        try (PreparedStatement psParcelaBaixaUpdate = connection.prepareStatement(sqlUpdateParcelas)) {
            ...
            psParcelaBaixaUpdate.setInt(17, idParcelaBanco);
