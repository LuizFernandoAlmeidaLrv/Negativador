 ...
 * @author luiz.almeida
 */
public class AtualizarRegistroBvsControl {

    private SOAPElement soapBodyElem;
     private SOAPElement idRegistro;
 ...
 public int callSoapWebService(ParcelasEnviarModel parcelasEnviarInclusaoBvsModel) throws ErroSistemaException {
        try {
            ...
            if (BvsMenssage.contains("true")) {
                ...
                resultado = parcelasEnviarController.RetornoAtualizaInclusaoBvs(parcelasEnviarInclusaoBvsModel, BvsMenssage, incluirBvsIdInclusao);
                retornoIncBvs = 1;
    ...
    private SOAPMessage createSOAPRequest(ParcelasEnviarModel parcelasEnviarInclusaoBvsModel) {
        try {
            ...
            soapBodyElem = soapBody.addChildElement("Atualizar_INCLUSAO_SEM_CHEQUE", myNamespace);
            idRegistro = soapBodyElem.addChildElement("p_idRegistro", myNamespace);
            ...
            idRegistro.setValue(parcelasEnviarInclusaoBvsModel.getIdRegistroFacmat()+"");
