 ...
 */
  ...
  public void addLock(Object... values) {
	...
	for (Object value : values) {
	  if (contains(value) && lockeds.contains(value) == false) {
		lockeds.add(value);
		list.add(value);
	  }
	}
  ...
  private void clearCheckeds(boolean valueIsAdjusting) {
	...
	checkeds.clear();
	fireRemoveCheckListModelListeners(new ArrayList<Object>(), valueIsAdjusting);
  }
  ...
  public void addCheck(Object... values) {
	...
	List<Object> list = new ArrayList<Object>();
	for (Object value : values) {
	  if (contains(value) && checkeds.contains(value) == false) {
		checkeds.add(value);
		list.add(value);
	  }
	}
